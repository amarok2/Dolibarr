...
/**
 *		\file       htdocs/theme/wapp/style.css.php
...
// Include bootstrap.min.css file (experimental)
require __DIR__.'/bootstrap.min.css';

// Include colors.inc.php file
require __DIR__.'/colors.inc.php';

// Include the wapp.inc.php that include the badges, btn, info-box, dropdown, progress...
require __DIR__.'/wapp.inc.php';
